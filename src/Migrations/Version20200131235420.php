 ...
 */
final class Version20200131235420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE owner owner_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE owner_id owner INT NOT NULL');
    }
}
